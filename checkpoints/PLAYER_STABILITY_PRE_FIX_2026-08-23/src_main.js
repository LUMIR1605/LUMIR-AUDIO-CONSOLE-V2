...
const playlist = createPlaylistEngine({ audio, onChange: renderPlaylist, beforePlay: () => audioFrame.resume() });
...
const nextDebug = query.get("debug-next") === "1" ? createNextDebug({ panel: nextDebugPanel, audio, playlist, audioFrame, nextButton: $("#next-button") }) : null;
